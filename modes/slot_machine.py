...
from core.tools import clear_console, yes_no_query_invoker, get_non_empty_int_range_input
...
class SlotMachineGame(BaseMode):
    ...
    def __display_status(self) -> None:
        ...
        print(f"Score: {self.current_score:,.2f}")
    ...
    def instructions(self) -> None:
        ...
        self.max_slots = get_non_empty_int_range_input("How many slots do you want to bet on? (3-10): ", 3, 10)
